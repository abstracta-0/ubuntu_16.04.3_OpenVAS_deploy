...
# run openvas-check-setup.sh script
...
# need to implement the OSPd element
# OSP protocol will allow us to have an even lighter Slave scanner deployment, so it will be super beneficial
